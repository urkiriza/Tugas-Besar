...
public class Declaration {
	...
	private void setProgramStudi(String programStudi) {
	...
	private void setLuasRuang(int luasRuang) {
		LuasRuang = luasRuang;
	}
	...
	private void setRasioLuas(int rasioLuas) {
		RasioLuas = rasioLuas;
	}
